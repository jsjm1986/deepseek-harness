...
export function InputBar({
  ...
  const onFileInputChange = (event: ChangeEvent<HTMLInputElement>): void => {
    ...
    // Clear the native value so selecting the same file again starts a new
    // intake after removal or failure.
          ...
          <div className={css.tools}>
            <Tooltip label={t('document.attach')} side="top" delayMs={500}>
              <button
                ...
                disabled={locked || machineBusy || (addImages === undefined && addDocuments === undefined)}
                onMouseDown={keepFocus}
